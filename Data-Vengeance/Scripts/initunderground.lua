...
local sectorList = {
    ...
    -- Tixa
    { location = "J9-1", loadscreens = { "LS_Prison_basement", "LS_Steps" }, },
    ...
    { location = "J14-1", },
    { location = "J14-2", },
    { location = "J13-2", loadscreen = "LS_Prison_basement", },
    { location = "J13-3", loadscreen = "LS_Prison_basement", }, 
    { location = "K13-3", },
...
local function PopulateSectors(difficultyLevel, gameStyle)
	...
	-- anv: VR robots
	s["F13-2"].numCreatures = 6
	s["F13-3"].numCreatures = 6
